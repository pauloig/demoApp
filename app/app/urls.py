...
urlpatterns = [
    ...
    path('create_authorized_prod_item/<id>/<invoiceID>',views.create_authorized_prod_item),
    path('update_authorized_prod_item/<id>/<invoiceID>',views.update_authorized_prod_item),
    path('delete_authorized_prod_item/<id>/<invoiceID>',views.delete_authorized_prod_item),
