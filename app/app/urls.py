...
urlpatterns = [
    ...
    path('create_authorized_prod_item/<id>',views.create_authorized_prod_item),
    path('update_authorized_prod_item/<id>',views.update_authorized_prod_item),
    path('delete_authorized_prod_item/<id>',views.delete_authorized_prod_item),
