...
urlpatterns = [
    ...
    path('update_order_daily/<woID>/<dailyID>',views.update_order_daily),
    path('create_daily/<pID>/<dID>/<LocID>',views.create_daily),
    path('update_daily/<daily>',views.update_daily),
    path('create_daily_emp/<id>',views.create_daily_emp),
    path('update_daily_emp/<id>',views.update_daily_emp),
    path('delete_daily_emp/<id>',views.delete_daily_emp),
